module.exports.tbl_ad_segc_geo_location = {
    path: {
        method: 'POST',
        path: '/server/main/tbl_ad_segc_geo_location',
        config: {
            auth: false,
            handler: function (request, reply) {
                try {
                    ...
                    params.push({
                        name: 'Id_geo_location',
                        type: module.exports.dbsql.Int,
                        value: reg.Id_geo_location
                    });
                    params.push({
                        name: 'latitude',
                    ...
                    call = {};
                    call.type = 'sql';
                    call.query = 'sp_tbl_ad_segc_geo_location';
