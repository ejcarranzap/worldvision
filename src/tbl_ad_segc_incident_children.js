module.exports.tbl_ad_segc_incident_children = {
    path: {
        method: 'POST',
        path: '/server/main/tbl_ad_segc_incident_children',
        config: {
            auth: false,
            handler: function (request, reply) {
                try {
                    ...
                    params.push({
                        ...
                        value: reg.Id_incident_children
                    });
                    params.push({
                    ...
                    call = {};
                    call.type = 'sql';
                    call.query = 'sp_tbl_ad_segc_incident_children';
