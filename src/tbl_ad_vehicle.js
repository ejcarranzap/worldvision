        ...
        config: {
            ...
            handler: function(request, reply) {
                try {
                    ...
                    if (reg.action == 'I' || reg.action == 'U') for (var i = 0; i < reg.deta0.length; i++) {
                    ...
                    if (reg.action == 'I' || reg.action == 'U') for (var i = 0; i < reg.deta1.length; i++) {
                    ...
                    if (reg.action == 'I' || reg.action == 'U') for (var i = 0; i < reg.deta2.length; i++) {
                    ...
                    if (reg.action == 'I' || reg.action == 'U') for (var i = 0; i < reg.deta3.length; i++) {
                    ...
                    if (reg.action == 'I' || reg.action == 'U') for (var i = 0; i < reg.deta4.length; i++) {
                    ...
                    if (reg.action == 'I' || reg.action == 'U') for (var i = 0; i < reg.deta5.length; i++) {
