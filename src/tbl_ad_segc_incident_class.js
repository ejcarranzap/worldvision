module.exports.tbl_ad_segc_incident_class = {
    path: {
        method: 'POST',
        path: '/server/main/tbl_ad_segc_incident_class',
        config: {
            auth: false,
            handler: function (request, reply) {
                try {
                    ...
                    params.push({
                        name: 'Id_incident_class',
                        type: module.exports.dbsql.Int,
                        value: reg.Id_incident_class
                    });
                    params.push({
                        name: 'Id_parent',
                        type: module.exports.dbsql.Int,
                    ...
                    call = {};
                    call.type = 'sql';
                    call.query = 'sp_tbl_ad_segc_incident_class';
