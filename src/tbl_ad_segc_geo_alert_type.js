module.exports.tbl_ad_segc_geo_alert_type = {
    path: {
        method: 'POST',
        path: '/server/main/tbl_ad_segc_geo_alert_type',
        config: {
            auth: false,
            handler: function (request, reply) {
                try {
                    ...
                    console.log('tbl_ad_segc_geo_alert_type', reg)
                    ...
                    call = {};
                    call.type = 'sql';
                    call.query = 'sp_tbl_ad_segc_geo_alert_type';
