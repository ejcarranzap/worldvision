(function() {
  ...
  app.controller('tbl_ad_tire_makeCtrl', function($scope, $rootScope, $log, $window, $http, $filter, autenticationService, $uibModal) {
    $rootScope.Panel = 'Marca de Neumatico';
    $rootScope.PanelTitle = 'Administración';
    $rootScope.PanelSubTitle = 'Catalogos';
    $rootScope.PanelSubSubTitle = 'Marca de Neumatico';
    $scope.record = {};
    $scope.data = {};
    $scope.pivot_data = {};
    ...
    $scope.open = function (record, size, actn) {
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'app/view/tbl_ad_tire_make_det.html?dt=' + (new Date()).getTime(),
                controller: 'tbl_ad_tire_make_detCtrl',
                size: size,
    ...
    $log.info('tbl_ad_tire_makeCtrl');
  });

  app.controller('tbl_ad_tire_make_detCtrl', function(Upload, $timeout, $scope, $rootScope, $log, $window, $http, $filter, autenticationService,
    ...
    $scope.save = function(){
      $scope.urls = [];
      $scope.urls.push({url: '/server/main/tbl_ad_tire_make', params: $scope.record, action: (!$scope.record.Id_tire_make ? 'I' : 'U')});
      autenticationService.call($scope.urls).then(function(results){
        setTimeout(function(){
    ...
    $log.info('tbl_ad_tire_make_detCtrl');
  });
}());
