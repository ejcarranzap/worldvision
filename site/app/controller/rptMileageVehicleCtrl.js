(function () {
  ...
  app.controller('rptMileageVehicleCtrl', function ($scope, $rootScope, $log, $window, $http, $filter, autenticationService, $uibModal) {
    $rootScope.Panel = 'Recorrido Vehículo';
    $rootScope.PanelTitle = 'Administración';
    $rootScope.PanelSubTitle = 'Reportes';
    $rootScope.PanelSubSubTitle = 'Recorrido Vehículo';
    $scope.record = {};
    ...
    $log.info('rptMileageVehicleCtrl');
  });
}());
