(function() {
  ...
  app.controller('tbl_ad_new_typeCtrl', function($scope, $rootScope, $log, $window, $http, $filter, autenticationService, $uibModal) {
    $rootScope.Panel = 'Tipo Siniestro';
    ...
    $scope.open = function (record, size, actn) {
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'app/view/tbl_ad_new_type_det.html?dt=' + (new Date()).getTime(),
                controller: 'tbl_ad_new_type_detCtrl',
                size: size,
    ...
    $log.info('tbl_ad_new_typeCtrl');
  });

  app.controller('tbl_ad_new_type_detCtrl', function(Upload, $timeout, $scope, $rootScope, $log, $window, $http, $filter, autenticationService,
    ...
    $scope.save = function(){
      $scope.urls = [];
      $scope.urls.push({url: '/server/main/tbl_ad_new_type', params: $scope.record, action: (!$scope.record.Id_new_type ? 'I' : 'U')});
      autenticationService.call($scope.urls).then(function(results){
        setTimeout(function(){
    ...
    $log.info('tbl_ad_new_type_detCtrl');
  });
}());
