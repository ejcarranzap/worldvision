(function() {
  ...
  app.controller('tbl_ad_user_typeCtrl', function($scope, $rootScope, $log, $window, $http, $filter, autenticationService, $uibModal) {
    $rootScope.Panel = 'Tipo de Usuario';
    $rootScope.PanelTitle = 'Administración';
    $rootScope.PanelSubTitle = 'Administración';
    $rootScope.PanelSubSubTitle = 'Tipo de Usuario';
    $scope.record = {};
    $scope.data = {};
    $scope.pivot_data = {};
    ...
    $scope.open = function (record, size, actn) {
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'app/view/tbl_ad_user_type_det.html?dt=' + (new Date()).getTime(),
                controller: 'tbl_ad_user_type_detCtrl',
                size: size,
    ...
    $log.info('tbl_ad_user_typeCtrl');
  });

  app.controller('tbl_ad_user_type_detCtrl', function(Upload, $timeout, $scope, $rootScope, $log, $window, $http, $filter, autenticationService,
    ...
    $scope.save = function(){
      $scope.urls = [];
      $scope.urls.push({url: '/server/main/tbl_ad_user_type', params: $scope.record, action: (!$scope.record.Id_user_type ? 'I' : 'U')});
      autenticationService.call($scope.urls).then(function(results){
        setTimeout(function(){
    ...
    $log.info('tbl_ad_user_type_detCtrl');
  });
}());
