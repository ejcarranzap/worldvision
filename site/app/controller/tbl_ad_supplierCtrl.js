(function() {
  ...
  app.controller('tbl_ad_supplierCtrl', function($scope, $rootScope, $log, $window, $http, $filter, autenticationService, $uibModal) {
    $rootScope.Panel = 'Proveedor';
    $rootScope.PanelTitle = 'Administración';
    $rootScope.PanelSubTitle = 'Catalogos';
    $rootScope.PanelSubSubTitle = 'Proveedor';
    $scope.record = {};
    $scope.data = {};
    $scope.pivot_data = {};
    ...
    $scope.open = function (record, size, actn) {
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'app/view/tbl_ad_supplier_det.html?dt=' + (new Date()).getTime(),
                controller: 'tbl_ad_supplier_detCtrl',
                size: size,
    ...
    $log.info('tbl_ad_supplierCtrl');
  });

  app.controller('tbl_ad_supplier_detCtrl', function(Upload, $timeout, $scope, $rootScope, $log, $window, $http, $filter, autenticationService,
    ...
    $scope.save = function(){
      $scope.urls = [];
      $scope.urls.push({url: '/server/main/tbl_ad_supplier', params: $scope.record, action: (!$scope.record.Id_supplier ? 'I' : 'U')});
      autenticationService.call($scope.urls).then(function(results){
        setTimeout(function(){
    ...
    $log.info('tbl_ad_supplier_detCtrl');
  });
}());
