(function() {
  ...
  app.controller('tbl_ad_makeCtrl', function($scope, $rootScope, $log, $window, $http, $filter, autenticationService, $uibModal) {
    $rootScope.Panel = 'Marca';
    $rootScope.PanelTitle = 'Administración';
    $rootScope.PanelSubTitle = 'Vehículos';
    $rootScope.PanelSubSubTitle = 'Marca';
    $scope.record = {};
    $scope.data = {};
    $scope.pivot_data = {};
    ...
    $scope.open = function (record, size, actn) {
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'app/view/tbl_ad_make_det.html?dt=' + (new Date()).getTime(),
                controller: 'tbl_ad_make_detCtrl',
                size: size,
    ...
    $log.info('tbl_ad_makeCtrl');
  });

  app.controller('tbl_ad_make_detCtrl', function(Upload, $timeout, $scope, $rootScope, $log, $window, $http, $filter, autenticationService,
