(function() {
  ...
  app.controller('tbl_ad_managerCtrl', function($scope, $rootScope, $log, $window, $http, $filter, autenticationService, $uibModal) {
    $rootScope.Panel = 'Responsable';
    $rootScope.PanelTitle = 'Administración';
    $rootScope.PanelSubTitle = 'Catalogos';
    $rootScope.PanelSubSubTitle = 'Responsable';
    $scope.record = {};
    $scope.data = {};
    $scope.pivot_data = {};
    ...
    $scope.open = function (record, size, actn) {
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'app/view/tbl_ad_manager_det.html?dt=' + (new Date()).getTime(),
                controller: 'tbl_ad_manager_detCtrl',
                size: size,
    ...
    $log.info('tbl_ad_managerCtrl');
  });

  app.controller('tbl_ad_manager_detCtrl', function(Upload, $timeout, $scope, $rootScope, $log, $window, $http, $filter, autenticationService,
    ...
    $scope.save = function(){
      $scope.urls = [];
      $scope.urls.push({url: '/server/main/tbl_ad_manager', params: $scope.record, action: (!$scope.record.Id_manager ? 'I' : 'U')});
      autenticationService.call($scope.urls).then(function(results){
        setTimeout(function(){
    ...
    $log.info('tbl_ad_manager_detCtrl');
  });
}());
