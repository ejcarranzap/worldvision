(function () {
    ...
    app.controller('rpt_proceso_por_usuarioCtrl', function ($scope, $filter, $routeParams, $uibModal, autenticationService) {
        ...
        $scope.getData = function () {
            $scope.urls = [];
            $scope.urls.push({ url: '/server/main/tbl_ad_process', type: 'formdata', params: $scope.record, action: 'SD_USER' });            
            autenticationService.call($scope.urls).then(function (results) {
                setTimeout(function () {
        ...
        console.log('rpt_proceso_por_usuarioCtrl');
    });
}());