...
var language = require('../../languages/zh-MO');

numbro.culture('zh-MO', language);
...
exports['culture:zh-MO'] = {
    ...
    currency: function (test) {
        ...
        var tests = [
            [1000.234,'$0,0.00','MOP1,000.23'],
            [-1000.234,'($0,0)','(MOP1,000)'],
            [-1000.234,'$0.00','-MOP1000.23'],
            [1230974,'($0.00a)','MOP1.23百萬']
        ];
