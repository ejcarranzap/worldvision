...
var numbro = require('../../numbro'),
    culture = require('../../languages/es-NI');

numbro.culture(culture.langLocaleCode, culture);

exports['culture:es-NI'] = {
    setUp: function (callback) {
        numbro.culture('es-NI');
        callback();
    },
    ...
    currency: function (test) {
        ...
        var tests = [
            [1000.234,'$0,0.00','C$1,000.23'],
            [-1000.234,'($0,0)','(C$1,000)'],
            [-1000.234,'$0.00','-C$1000.23'],
            [1230974,'($0.00a)','C$1.23mm']
        ];
